...
$result = [System.Windows.Forms.MessageBox]::Show('????!' + [System.Environment]::NewLine + [System.Environment]::NewLine + "парпр VPN, TUN, Proxy парпр", "D.F.E" , [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
