...
if ($result -eq 'Yes') {
	...
	$result = [System.Windows.Forms.MessageBox]::Show('D.F.E успешно установлен. Запустите D.F.E_starter на вашем рабочем столе, чтобы обход заработал. Чтобы удалить его, запустите скрипт снова. Вам предложат его удалить. Удачи!. Чтобы удалить его, запустите скрипт снова. Вам предложат его удалить. Удачи!' + [System.Environment]::NewLine + [System.Environment]::NewLine + "by Sam", "D.F.E" , [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
