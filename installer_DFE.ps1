...
if ($result -eq 'Yes') {
	...
	$result = [System.Windows.Forms.MessageBox]::Show('D.F.E успешно установлен. Запустите D.F.E_starter на вашем рабочем столе, чтобы обход заработал. Чтобы удалить его, запустите скрипт снова. Вам предложат его удалить. Удачи!. Чтобы удалить его, запустите скрипт снова. Вам предложат его удалить. Удачи!' + [System.Environment]::NewLine + [System.Environment]::NewLine + ":)", "D.F.E" , [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)

}
if ($result -eq 'No') {
	exit
}° РІР°С€РµРј СЂР°Р±РѕС‡РµРј СЃС‚РѕР»Рµ, С‡С‚РѕР±С‹ РѕР±С…РѕРґ Р·Р°СЂР°Р±РѕС‚Р°Р». Р§С‚РѕР±С‹ СѓРґР°Р»РёС‚СЊ РµРіРѕ, Р·Р°РїСѓСЃС‚РёС‚Рµ СЃРєСЂРёРїС‚ СЃРЅРѕРІР°. Р’Р°Рј РїСЂРµРґР»РѕР¶Р°С‚ РµРіРѕ СѓРґР°Р»РёС‚СЊ. РЈРґР°С‡Рё!. Р§С‚РѕР±С‹ СѓРґР°Р»РёС‚СЊ РµРіРѕ, Р·Р°РїСѓСЃС‚РёС‚Рµ СЃРєСЂРёРїС‚ СЃРЅРѕРІР°. Р’Р°Рј РїСЂРµРґР»РѕР¶Р°С‚ РµРіРѕ СѓРґР°Р»РёС‚СЊ. РЈРґР°С‡Рё!' + [System.Environment]::NewLine + [System.Environment]::NewLine + ":)", "D.F.E" , [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
