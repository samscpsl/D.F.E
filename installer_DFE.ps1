...
if ($result -eq 'Yes') 
{
	...
	#$result = [System.Windows.Forms.MessageBox]::Show('D.F.E успешно установлен. Чтобы удалить его, запустите скрипт снова. Вам предложат его удалить. #Удачи!' + [System.Environment]::NewLine + [System.Environment]::NewLine + "Ухх бляяяяять..........", "D.F.E" , [
	#ystem.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
}
if ($result -eq 'No') {
	exit
}