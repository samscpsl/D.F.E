...
$result = [System.Windows.Forms.MessageBox]::Show('Вопрос:' + [System.Environment]::NewLine + [System.Environment]::NewLine + 'Вы отключили VPN, GoodbyeDPI, туннели и прочие приблуды?' , "D.F.E" , [System.Windows.Forms.MessageBoxButtons]::YesNo, [System.Windows.Forms.MessageBoxIcon]::Error)
	if ($result -eq 'No') {
		exit
	}
